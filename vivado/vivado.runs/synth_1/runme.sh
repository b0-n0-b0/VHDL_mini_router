...
HD_PWD='C:/Users/Franco Califano/Downloads/VHDL_mini_router-main/VHDL_mini_router-main/vivado/vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mini_router.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mini_router.tcl
